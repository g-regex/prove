...
int main(int argc, char *argv[])
{
	...
	fprintf(tikz, "%%This file is automatically generated by [prove]\n"
			"\\title{Graph}\n"
	...
	fprintf(tikz, "\\begin{figure}[h!]"
		...
		"\\begin{scope}["
		"every node/.style={rectangle,inner sep=3pt,minimum width=3pt, minimum height=11pt, text height=5pt,yshift=0pt}, "
