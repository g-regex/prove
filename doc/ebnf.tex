...
\langle\texttt{statement}\rangle & =\textrm{`['}\Big(\langle\texttt{expr}\rangle\Big|\langle\texttt{symbol}\rangle\Big)\textrm{`]'}\bigg\{\textrm{`['}\Big(\langle\texttt{expr}\rangle\Big|\langle\texttt{symbol}\rangle\Big)\textrm{`]'\ensuremath{\bigg\}}}\\
