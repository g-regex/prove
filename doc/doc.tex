...
\newcommand\examplenl[1]{
	...
	\caption{Representation of source~code~\ref{code:#1}}\label{fig:#1}
	\centering
	\includegraphics[width=\textwidth, height=8cm, keepaspectratio]{tikz/#1.pdf}
	\end{figure}
...
\centering
\includegraphics[width=\textwidth, height=6cm, keepaspectratio]{tikz/impl1.pdf}
\end{figure}
...
In source~code~\ref{code:var1} the method of verification used for 
source~code~\ref{code:impl1} fails, since node~1 is unkown from the perspective
