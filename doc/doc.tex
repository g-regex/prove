...
\textcolor{dartmouthgreen}{\begin{itemize}
	...
	\item
		...
		node contains node with the \texttt{NEWC} flag set. The identifiers in
		these nodes are subject to substitution. To all nodes to the right of
		the node carrying the \texttt{VAR} flag, the newly declared identifiers
		are unknown.
\end{itemize}}
